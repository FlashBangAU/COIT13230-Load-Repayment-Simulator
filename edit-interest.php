    ...
    <div class="container d-flex flex-column min-vh-100">
        <?php
            ...
            if ($validLogin || $validSession) {
                echo "<h1 class='my-4'>Edit Interest</h1>";
                    ...
                    if (empty($_POST['date']) || empty($_POST['interest'])){
                        ...
                        if ($newDate === $date && $newInterest === $interest && $updatePMT === $changedPMT) {
                            ...
                            if ($stmt) {
                                ...
                                if ($affectedRows >= 0) {
                                    echo "<p class='text-success'>Successfully Updated Interest</p>";
                                } else {
                                    echo "<p class='text-danger'>Failed to Update Interest in Database.</p>";
                                }
                            } else {
