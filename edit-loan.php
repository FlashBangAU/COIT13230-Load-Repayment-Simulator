    ...
    <div class="container d-flex flex-column min-vh-100">
        <?php
            ...
            if ($validLogin || $validSession) {
                echo '<h1  class="my-4">Edit Loan</h1>';
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
                    ...
                    if (empty($_POST['date']) || empty($_POST['interest']) || empty($_POST['principle']) || empty($_POST['duration']) || empty($_POST['payment'])) {
                        ...
                        if ($stmt) {
                            ...
                            if ($affectedRows === 1) {
                                echo "<p class='text-success'>Successfully Updated Loan</p>";
                            } else {
                                echo "<p class='text-danger'>Failed to Update Loan in Database. No changes detected.</p>";
                            }
                        } else {
                            echo "Error preparing statement: " . $db->error;
                        }
