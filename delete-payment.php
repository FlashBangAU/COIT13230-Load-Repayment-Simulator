    ...
    <div class="container d-flex flex-column min-vh-100">
        <?php
            ...
            if ($validLogin || $validSession) {
                echo "<h1 class='my-4'>Delete Payment</h1>";
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($affectedRows == 1) {
                        echo "<p class='text-success'>Successfully Deleted Payment</p>";
                    } else {
                        echo "<p class='text-danger'>Failed to Delete Payment in Database</p>";
                    }
